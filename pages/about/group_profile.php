<?php $title = "Group profile - Clicks 2018"; ?>

<?php include '../../snippets/header.php' ?>

<main>
    <div class="container content-styling large-content-padding group-profile">
        <div class="row">
            ...
            <div class="col-9 col-lg-10 side-padding">
                ...
                <ul>
                    ...
                    <li>Clicks ClubCard is one of the largest loyalty programmes in South Africa with over 7.8 million active members</li>
                    <li>76% of ClubCard customers are women and 68% are in the 25 to 49 age group</li>
                    <li>50% of households live within five kilometres of a Clicks store</li>
                </ul>
                <p class="margin-bottom-0">The franchise brands were introduced through exclusive franchise agreements to provide additional differentiation to the Clicks offering:</p>
                <ul>
                    <li>2001 – The Body Shop, which sells natural, ethically-produced beauty products</li>
                    <li>2014 – GNC, the largest global specialty health and wellness retailer</li>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td rowspan="2" class="bottom border-bottom-thin">
                                <h4 class="sky-blue">Store <br>footprint</h4>
                            </td>
                            <td colspan="3" class="bottom text-center dark-blue-bg border-bottom-white-thin"><b class="white">Standalone stores</b></td>
                            <td rowspan="2" class="bottom border-bottom-thin sky-blue-bg text-right">
                                <b class="white">Pharmacies</b>
                            </td>
                            <td rowspan="2" class="bottom border-bottom-thin sky-blue-bg text-right">
                                <b class="white">Presence<br>in Clicks stores</b>
                            </td>
                        </tr>
                        <tr>
                            <td class="bottom text-right sky-blue-bg border-bottom-thin"><b class="white">South Africa</b></td>
                            <td class="bottom text-right sky-blue-bg border-bottom-thin"><b class="white">Rest of Africa</b></td>
                            <td class="bottom text-right sky-blue-bg border-bottom-thin"><b class="white">Total</b></td>
                        </tr>
                        <tr>
                            <td>Clicks</td>
                            <td class="text-right"><b>630</b></td>
                            <td class="text-right"><b>33</b></td>
                            <td class="text-right"><b>663</b></td>
                            <td class="text-right light-blue-bg"><b>510</b></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right light-blue-bg"></td>
                            <td class="text-right light-blue-bg"><b>170</b></td>
                        </tr>
                        <tr>
                            <td>Claire’s</td>
                            ...
                            <td class="text-right"><b>6</b></td>
                            <td class="text-right light-blue-bg"></td>
                            <td class="text-right light-blue-bg"><b>168</b></td>
                        </tr>
                        <tr>
                            <td>GNC</td>
                            <td class="text-right"><b>–</b></td>
                ...
                <div class="row margin-bottom-40px">
                    <div class="col-12 col-xl-10 offset-xl-1">
                        <div class="row margin-bottom-20px">
                            <div class="col-7 text-center d-flex flex-column align-items-center justify-content-end">
                                <h3><b class="dark-blue">Market share</b></h4>
                                <div class="dash smaller-margin"></div>
                                <h3 class="sky-blue"><span class="sky-blue larger">23.3%</span> <br>of retail pharmacy</h3>
                                <div class="dash smaller-margin"></div>
                                <h3 class="sky-blue"><span class="sky-blue larger">30.8%</span> <br>of front shop health</h3>
                                <div class="dash smaller-margin"></div>
                                
                            </div>
                            <div class="col-5 d-flex align-items-center justify-content-center">
                                <div class="dark-blue-bg box-padding width-100 text-center neg-top-margin">
                                    <h3 class="white margin-bottom-20px"><span class="larger xl white">663</span> <br>stores</h3>
                                    <h3 class="white"><span class="larger xl white">510</span> <br>pharmacies</h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row margin-bottom-40px">
                    <div class="col-12 col-xl-10 offset-xl-1">
                        <div class="row margin-bottom-20px">
                            <div class="col-7 text-center d-flex flex-column align-items-center justify-content-end">
                                <h3><b>Market share</b></h4>
                                <div class="dash smaller-margin"></div>
                                <h3 class="sky-blue"><span class="sky-blue larger">26.0%</span> <br>of private pharmaceutical market</h3>
                                <div class="dash smaller-margin"></div>
                            </div>
                            <div class="col-5 d-flex align-items-center justify-content-center">
                                <div class="dark-blue-bg box-padding width-100 text-center neg-top-margin">
                                    <h3 class="white margin-bottom-20px"><span class="larger xl white">5</span> <br>distribution centres</h3>
                                    <h3 class="white"><span class="larger xl white">230</span> million <br>units of medicine delivered</h3>
                                </div>
                            </div>
                        </div>
                        <img class="float-left" src="assets/img/play.png" alt="Play">

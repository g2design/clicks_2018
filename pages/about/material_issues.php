<?php $title = "Managing material issues - Clicks 2018"; ?>

<?php include '../../snippets/header.php' ?>

<main>
    <div class="container content-styling large-content-padding material-issues">
        <div class="row">
            ...
            <div class="col-9 col-lg-10 side-padding">
                ...
                <p>The material issues are reviewed annually by the board and management where all relevant internal, industry and macroeconomic factors are evaluated. The needs, expectations and concerns of the stakeholder groups that are most likely to influence the group’s ability to create sustainable value, notably customers, suppliers, regulators, staff, shareholders and providers of financial capital are central to determining the material issues.</p>
                <p>Following the review for the 2019 financial year, the directors confirm that the current material issues remain relevant and are unchanged from the previous year.</p>
                <div class="dash"></div>
                <p><span class="sky-blue heading-3 text-uppercase">Risks</span> relating to each material issue are based on the major risks on the group’s register. The risk heat map below indicates the levels of risk before (inherent risk) and after (residual risk) mitigation plans have been implemented.</p>
                <div class="dash"></div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <h2 class="text-uppercase margin-bottom-0">Trading environment</h2>
                    </div>
                    <div class="col-6">
                        <div class="dash margin-bottom-40px"></div>
                        <h2 class="text-uppercase margin-bottom-0">Competition</h2>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                        <p class="margin-bottom-40px">Low economic growth, deteriorating economic conditions and the resultant poor consumer sentiment are impacting South Africa’s already constrained retail trading environment. Consumer disposable income has been further eroded by the increase in VAT, rising fuel and utility prices, higher health insurance costs and increasing general living costs.</p>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                        <p class="margin-bottom-40px">Clicks faces competition on several fronts, including national food retailers and general merchandise chains, and other pharmacy businesses.</p>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                    ...
                    <div class="col-6">
                        ...
                        <ul class="margin-bottom-40px margin-top-0">
                            ...
                            <li>Ongoing improvements in pricing, product offer and customer service.</li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <div class="dash margin-bottom-40px"></div>
                        <h2 class="text-uppercase margin-bottom-0">Regulation</h2>
                    </div>
                    <div class="col-6">
                        <div class="dash margin-bottom-40px"></div>
                        <h2 class="text-uppercase margin-bottom-0">People</h2>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                        <p class="margin-bottom-40px margin-top-20px">Healthcare markets are highly regulated across the world and approximately 50% of the group’s turnover is in regulated pharmaceutical products. The group supports regulation that advances the government’s healthcare agenda of making medicines more affordable and more accessible but opposes regulation which inhibits access to affordable healthcare and limits customer choice.</p>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                    ...
                    <div class="col-6">
                        <div class="dash"></div>
                        <h3 class="text-uppercase sky-blue margin-top-20px margin-bottom-0">Risk</h3>
                        <ul class="margin-bottom-40px margin-top-0">
                    ...
                    <div class="col-6">
                        ...
                        <ul class="margin-bottom-40px margin-top-0">
                            ...
                            <li>Partner with government to be a preferred service provider to the NHI scheme.</li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <div class="dash"></div>
                        ...
                        <ul class="margin-bottom-40px margin-top-0">
                            ...
                            <li>Retail graduate programme offered.</li>
                            <li>Accredited training programmes for store management, key store roles and merchandise and planning rolled out.</li>
                            <li>Senior leadership development programme strengthens pool of management talent and provides succession plan.</li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <div class="dash margin-bottom-40px"></div>
                        <h2 class="text-uppercase margin-bottom-0">Information technology</h2>
                    </div>
                    <div class="col-6"></div>
                    <div class="col-6">
                        <div class="dash"></div>
                        <p class="margin-bottom-40px">Real-time, uninterrupted IT systems are essential in today’s technology-driven business environment while robust IT security and governance processes are required to limit breaches of customer privacy and loss of data to avoid legal liability and reputational damage.</p>
                    </div>
                    <div class="col-6">
                    </div>
                    <div class="col-6">

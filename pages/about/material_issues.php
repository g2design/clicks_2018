        ...
        <div class="row">
            ...
            <div class="col-9 col-lg-10 side-padding">
                ...
                <div class="row">
                    ...
                    <div class="col-6 dark-blue-border-bottom">
                        <h2 class="text-uppercase margin-bottom-40px margin-top-20px">Regulation</h2>
                    </div>
                    <div class="col-6 dark-blue-border-bottom">
                        <h2 class="text-uppercase margin-bottom-40px margin-top-20px">People</h2>
                    </div>
                    <div class="col-6 dark-blue-border-bottom">
                    ...
                    <div class="col-6 dark-blue-border-bottom">
                        <h2 class="text-uppercase margin-bottom-40px margin-top-20px">Information technology</h2>
                    </div>
                    <div class="col-6"></div>
                    <div class="col-6 dark-blue-border-bottom">
                        <p class="margin-bottom-40px margin-top-20px">Real-time, uninterrupted IT systems are essential in today’s technology-driven business environment while robust IT security and governance processes are required to limit breaches of customer privacy and loss of data to avoid legal liability and reputational damage.</p>
                    </div>
                    <div class="col-6">
                    </div>
                    <div class="col-6 dark-blue-border-bottom">

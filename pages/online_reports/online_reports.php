<?php $title = "Online Reports - Clicks 2018"; ?>

<?php include '../../snippets/header.php' ?>

<main>
    <div class="container content-styling large-content-padding">
        <div class="row">
            <div class="col-12 side-padding">
                <h1 class="text-uppercase margin-bottom-0">Online Reports</h1>
                <div class="dash"></div>
                <div class="row">
                    <div class="col-8">
                        <a href="">

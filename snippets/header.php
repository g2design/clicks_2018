...
<body>
	...
	<header>
		<div class="top-header">
						...
						<div class="row">
							<div class="col-6 offset-5">
								<ul class="float-right">
									<li>
										<img src="assets/img/icons/downloads.png" alt="Downloads">
										<span class="white">Downloads</span>
										<div class="dropdown text-left">
											<ul>
												<li class="margin-bottom-10px"><a href="assets/pdfs/Clicks_IAR_2017.pdf" target="_blank">Integrated Annual Report 2017</a></li>
												<li><b class="blue">Financial reporting</b></li>
												...
												<li><b class="blue">Governance</b></li>
												<li class="margin-bottom-10px"><a href="assets/pdfs/Clicks_CorpGov_2017_online.pdf" target="_blank">Corporate governance report 2017 (incorporating King IV)</a></li>
												<li><b class="blue">Annual general meeting</b></li>
												...
												<li><b class="blue">Sustainability</b></li>
									...
									<li>
										<img src="assets/img/icons/file.png" alt="Shareholder Information">
										<span class="white">Shareholder Information</span>
										<div class="dropdown text-left">
											<ul>
												<li><a href="<?php echo $baseUrl; ?>pages/governance/shareholder_analysis" target="_blank">Analysis of shareholders</a></li>
												<li><a href="<?php echo $baseUrl; ?>pages/governance/corporate_info">Corporate information</a></li>
												<li><a href="<?php echo $baseUrl; ?>pages/governance/shareholder_diary">Shareholders' diary</a></li>
											</ul>
										</div>
									</li>
								</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-md-6 padding-15px">
						<a href="<?php echo $baseUrl; ?>">
							<img class="logo" src="assets/img/logos/clicks.png" alt="Logo">
						</a>
					</div>
					<div class="col-12 col-md-6 search justify-content-end d-flex align-items-center">
						<form action="search">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 text-center light-blue-background">
						<h3 class="text-uppercase white">Integrated Annual Report 2017</h3>
					</div>
				</div>
			</div>
		</div>
		<div class="main-nav grey-background">
			<div class="container d-flex justify-content-center">
				<div class="row d-flex justify-content-center">
					<div class="col-12">
						<nav class="dark-blue-background d-flex">
							<a class="light-blue-background home d-flex align-items-center" href="<?php echo $baseUrl; ?>">
								<img src="assets/img/icons/home.png" alt="Home">
							</a>
							<ul class="d-flex align-items-center text-center max-width-100">
								<li class="menu-item">
									<span class="navbar-item">Group Overview and Strategy</span>
									<div class="dropdown text-left">
										<ul>
								...
								<li class="menu-item">
									<a class="navbar-item" href="pages/financial_statements/financial_statements">Annual Financial Statements</a>
									<div class="dropdown text-left">
										<ul>
											<li><h5 class="blue remove-bottom-margin">AUDITED ANNUAL FINANCIAL STATEMENTS 2017</h5></li>
								...
								<li class="menu-item">
									<a class="navbar-item" href="pages/onlinereports/onlinereports">Additional online reporting</a>
									<div class="dropdown text-left">
										<ul>
											<li class="margin-bottom-10px"><a href="assets/pdfs/Clicks_IAR_2017.pdf" target="_blank">Integrated Annual Report 2017</a></li>
											<li><b class="blue">Financial reporting</b></li>
		 ...
		 <div class="container">
		 	<div class="row">
		 		<div class="col-12 text-center">
		 			<img class="logo margin-bottom-20px" src="assets/img/logos/clicks.png" alt="Logo" style="width: 350px">
